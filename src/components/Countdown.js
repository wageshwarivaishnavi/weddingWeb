...
function Countdown() {
  ...
  useEffect(() => {
    ...
    const weddingDate = "Feb 19, 2026 11:00:00";
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 text-center countdown-header">
            <span
              className="countdown-subtitle animate-box"
              data-animate-effect="fadeInUp"
            >
              Save The Date
            </span>
            <h2
              className="countdown-title animate-box"
              data-animate-effect="fadeInUp"
            >
        ...
        <div className="row">
          <div className="col-md-12 text-center">
            <p className="countdown-message">
              <i className="ti-heart"></i> Can't wait to celebrate with you!{" "}
              <i className="ti-heart"></i>
            </p>
          </div>
        </div>
